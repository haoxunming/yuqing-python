...
# 第一种动态UA(从自定义的USER_AGENTS列表中获取)
from website_wangyi.settings import USER_AGENTS
...
class WebsiteWangyiSpiderMiddleware:
...
class WebsiteWangyiDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
